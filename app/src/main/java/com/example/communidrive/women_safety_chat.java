...
public class women_safety_chat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_safety_chat);
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("chat").child("details").child("traffic");
